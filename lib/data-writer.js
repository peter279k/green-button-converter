...
class DataWriter {
  ...
  output(format = false) {
    ...
    let greenButtonData = xmlBuilder.create('feed', {encoding: 'utf-8'})
            ...
            .ele('title', {}, 'Green Button Electric Data User Feed').up()
            .ele('updated', {}, publishedDate).up()
            .ele('entry')
            .ele('id', {}, 'urn:uuid:' + DataWriter.getId()).up()
            .ele('link', {rel: 'self', href: 'DataCustodian/espi/1_1/resource/Subscription/5/UsagePoint/1'}).up()
            .ele('link', {rel: 'up', href: 'DataCustodian/espi/1_1/resource/Subscription/5/UsagePoint'}).up()
            .ele('link', {rel: 'related', href: 'UsagePoint/01/MeterReading'}).up()
            .ele('link', {rel: 'related', href: 'DataCustodian/espi/1_1/resource/Subscription/5/UsagePoint/1/ElectricPowerUsageSummary'}).up()
            ...
            .ele('entry')
            .ele('id', {}, 'urn:uuid:' + DataWriter.getId()).up()
            .ele('link', {rel: 'self', href: 'UsagePoint/01/MeterReading/01'}).up()
            .ele('link', {rel: 'up', href: 'UsagePoint/01/MeterReading'}).up()
            .ele('link', {rel: 'related', href: 'UsagePoint/01/MeterReading/01/IntervalBlock'}).up()
            ...
            .ele('entry')
            .ele('id', {}, 'urn:uuid:' + DataWriter.getId()).up()
            .ele('link', {rel: 'self', href: 'UsagePoint/01/MeterReading/01/IntervalBlock/024'}).up()
            .ele('link', {rel: 'up', href: 'UsagePoint/01/MeterReading/01/IntervalBlock'}).up()
            .ele('title', {}, 'Durations for Electric Meter Reading').up()
            .ele('content')
    ...
    greenButtonData
        ...
        .ele('entry')
        .ele('id', {}, 'urn:uuid:' + DataWriter.getId()).up()
        .ele('link', {rel: 'up', href: 'DataCustodian/espi/1_1/resource/Subscription/5/UsagePoint/1/ElectricPowerUsageSummary'}).up()
        .ele('link', {rel: 'self', href: 'DataCustodian/espi/1_1/resource/Subscription/5/UsagePoint/1/ElectricPowerUsageSummary/1'}).up()
        .ele('link', {rel: 'related', href: 'UsagePoint/01'}).up()
        .ele('title', {}, 'Usage Summary').up()
        .ele('content')
          .ele('UsageSummary', xmlEspiNs)
            .ele('billingPeriod')
              .ele('duration', {}, '2419200').up()
              .ele('start', {}, '1391230800').up().up()
            .ele('billLastPeriod', {}, '6752000').up()
            .ele('billToDate', {}, '4807000').up()
            .ele('costAdditionalLastPeriod', {}, '0').up()
            .ele('currency', {}, '840').up()
            .ele('overallConsumptionLastPeriod')
              .ele('powerOfTenMultiplier', {}, '0').up()
              .ele('uom', {}, '72').up()
              .ele('value', {}, '625716').up().up()
            .ele('currentBillingPeriodOverAllConsumption')
              .ele('powerOfTenMultiplier', {}, '0').up()
              .ele('timeStamp', {}, '1395374400').up()
              .ele('uom', {}, '72').up()
              .ele('value', {}, '447993').up().up()
              .ele('qualityOfReading', {}, '14').up()
              .ele('statusTimeStamp', {}, '1395374400').up().up().up()
          .ele('published', {}, publishedDate).up()
          .ele('updated', {}, publishedDate).up().up()
